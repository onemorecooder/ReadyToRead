    ...
    <div class="row">
      ...
      <div id="main" class="column">
        <form id="contact_form" method="post">
          ...
          <input type="text" id="fname" name="firstname" style="text-transform: capitalize;" placeholder="Your name...">
          <label for="lname">Last Name</label>
          <input type="text" id="lname" name="lastname" style="text-transform: capitalize;" placeholder="Your last name...">
          <label for="mail">Email</label>
          <input type="email" id="mail" name="email" placeholder="Your Emalil...">
          <label for="subject">Subject</label>
          <input type="text" id="subject" name="subject" style="text-transform: capitalize;" placeholder="Your Subject.">
          <label for="message">Message</label>
          <textarea id="message" name="message" placeholder="Write something.." style="height:170px; resize:none"></textarea>
